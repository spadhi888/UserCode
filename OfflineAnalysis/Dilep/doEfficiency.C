...
//     if ( TMath::Abs(cms2.hyp_lt_id()[i_hyp]) == 11 && trueElectronFromW_WJets(cms2.hyp_lt_index()[i_hyp]) ) {
       helePt[myType]->Fill(cms2.hyp_ll_p4()[i_hyp].pt(), weight);
       heleEta[myType]->Fill(cms2.hyp_ll_p4()[i_hyp].eta(), weight);
       helePhi[myType]->Fill(cms2.hyp_ll_p4()[i_hyp].phi(), weight); 
       helePt[3]->Fill(cms2.hyp_ll_p4()[i_hyp].pt(), weight);
       heleEta[3]->Fill(cms2.hyp_ll_p4()[i_hyp].eta(), weight);
       helePhi[3]->Fill(cms2.hyp_ll_p4()[i_hyp].phi(), weight);
      }
...
//     if ( TMath::Abs(cms2.hyp_ll_id()[i_hyp]) == 11 && trueElectronFromW_WJets(cms2.hyp_ll_index()[i_hyp]) ) {
       helePt[myType]->Fill(cms2.hyp_lt_p4()[i_hyp].pt(), weight);
       heleEta[myType]->Fill(cms2.hyp_lt_p4()[i_hyp].eta(), weight);
       helePhi[myType]->Fill(cms2.hyp_lt_p4()[i_hyp].phi(), weight);
       helePt[3]->Fill(cms2.hyp_lt_p4()[i_hyp].pt(), weight);
       heleEta[3]->Fill(cms2.hyp_lt_p4()[i_hyp].eta(), weight);
       helePhi[3]->Fill(cms2.hyp_lt_p4()[i_hyp].phi(), weight);
      }
