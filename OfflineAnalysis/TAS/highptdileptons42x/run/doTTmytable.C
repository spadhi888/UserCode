...
//  gROOT->ProcessLine(".x Tools/setup.C");
  ...
  pair<Float_t, Double_t> ttww_ee = doErrors(ftt, "ttbar_hnJetWW_ee");
  pair<Float_t, Double_t> ttww_mm = doErrors(ftt, "ttbar_hnJetWW_mm");
  pair<Float_t, Double_t> ttww_em = doErrors(ftt, "ttbar_hnJetWW_em");
  pair<Float_t, Double_t> ttww_all = doErrors(ftt, "ttbar_hnJetWW_all");


  pair<Float_t, Double_t> ttwo_ee = doErrors(ftt, "ttbar_hnJetWO_ee");
  pair<Float_t, Double_t> ttwo_mm = doErrors(ftt, "ttbar_hnJetWO_mm");
  pair<Float_t, Double_t> ttwo_em = doErrors(ftt, "ttbar_hnJetWO_em");
  pair<Float_t, Double_t> ttwo_all = doErrors(ftt, "ttbar_hnJetWO_all");

  pair<Float_t, Double_t> ttwosemi_ee = doErrors(ftt, "ttbar_hnJetWOSemilep_ee");
  pair<Float_t, Double_t> ttwosemi_mm = doErrors(ftt, "ttbar_hnJetWOSemilep_mm");
  pair<Float_t, Double_t> ttwosemi_em = doErrors(ftt, "ttbar_hnJetWOSemilep_em");
  pair<Float_t, Double_t> ttwosemi_all = doErrors(ftt, "ttbar_hnJetWOSemilep_all");

  pair<Float_t, Double_t> ttwosemioth_ee = doErrors(ftt, "ttbar_hnJetWOOther_ee");
  pair<Float_t, Double_t> ttwosemioth_mm = doErrors(ftt, "ttbar_hnJetWOOther_mm");
  pair<Float_t, Double_t> ttwosemioth_em = doErrors(ftt, "ttbar_hnJetWOOther_em");
  pair<Float_t, Double_t> ttwosemioth_all = doErrors(ftt, "ttbar_hnJetWOOther_all");

  pair<Float_t, Double_t> other_ee = doErrors(ftt, "ttbar_hnJetOO_ee");
  pair<Float_t, Double_t> other_mm = doErrors(ftt, "ttbar_hnJetOO_mm");
  pair<Float_t, Double_t> other_em = doErrors(ftt, "ttbar_hnJetOO_em");
  pair<Float_t, Double_t> other_all = doErrors(ftt, "ttbar_hnJetOO_all");
