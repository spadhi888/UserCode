  ...
  for (int i=0; i<4; i++) {
	...
	hnJet[i] = new TH1F((string(prefix)+"_hnJet_" + string(suffixall[i])).c_str(),(string(prefix)+"_nJet_" + string(suffixall[i])).c_str(),
        ...
        hnMET[i] = new TH1F((string(prefix)+"_hnMET_" + string(suffixall[i])).c_str(),(string(prefix)+"_hnMET_" + string(suffixall[i])).c_str(),
                            NBINSPT, MINPT, MAXPT);
        hnevt_nvtxs[i] = new TH1F((string(prefix)+"_hnevt_nvtxs_" + string(suffixall[i])).c_str(),(string(prefix)+"_hnevt_nvtxs_" + string(suffixall[i])).c_str(), 100, 0, 100);
        hnevt_ndavtxs[i] = new TH1F((string(prefix)+"_hnevt_ndavtxs_" + string(suffixall[i])).c_str(),(string(prefix)+"_hnevt_ndavtxs_" + string(suffixall[i])).c_str(), 100, 0, 100);
