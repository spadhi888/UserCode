...
void getPredicted(TString f_NoMETCut, TString f_wMETCut, const char *formatS = "%6.2f") {
  ...
  for(int nJet = 0; nJet < 3; nJet++) {
    ...
    cout <<"|  " <<  nJet << "  |  "
      	 << formatFloat(p_nllIn_ee.first,formatS)     << " +/- " << formatFloat(sqrt(p_nllIn_ee.second),formatS)   << "  |  " 
	 << formatFloat(p_nIn_emu.first,formatS)      << " +/- " << formatFloat(sqrt(p_nIn_emu.second),formatS)    << "  |  "
	 << formatFloat(p_rOutIn_ee.first,formatS)    << " +/- " << formatFloat(sqrt(p_rOutIn_ee.second),formatS)  << "  |  "
	 << formatFloat(predicted_ee,formatS)         << " +/- " << formatFloat(sqrt(predictedErr2_ee),formatS)    << "  |  "
	 << formatFloat(p_truNOut_ee.first,formatS)   << " +/- " << formatFloat(sqrt(p_truNOut_ee.second),formatS) << "  |  " << endl;
  ...
  for(unsigned int i = 0 ; i < v_k_ee.size(); i++) 
    cout << "|  " << i << "  |  " 
	 << formatFloat(v_k_ee.at(i).first,formatS) << " +/- " << formatFloat(sqrt(v_k_ee.at(i).second),formatS) << "  |" << endl;
  ...
  for(int nJet = 0; nJet < 3; nJet++) {
    ...
    //mm
    cout << "|  " << nJet << "  |  " 
	 << formatFloat(p_nllIn_mm.first,formatS)   << " +/- " << formatFloat(sqrt(p_nllIn_mm.second),formatS)   << "  |  "
	 << formatFloat(p_nIn_emu.first,formatS)    << " +/- " << formatFloat(sqrt(p_nIn_emu.second),formatS)    << "  |  "
	 << formatFloat(p_rOutIn_mm.first,formatS)  << " +/- " << formatFloat(sqrt(p_rOutIn_mm.second),formatS)  << "  |  "	 
	 << formatFloat(predicted_mm,formatS)       << " +/- " << formatFloat(sqrt(predictedErr2_mm),formatS)    << "  |  "
	 << formatFloat(p_truNOut_mm.first,formatS) << " +/- " << formatFloat(sqrt(p_truNOut_mm.second),formatS) << "  |" << endl;
  ...
  h_Nout_ee->GetYaxis()->SetRangeUser(0,2.);
  ...
  h_Nout_mm->GetYaxis()->SetRangeUser(0,2.);
