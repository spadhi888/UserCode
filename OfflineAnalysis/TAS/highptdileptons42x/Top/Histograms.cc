...
TH1F* hnbJet[4];                   // Njet distributions
TH1F* hnblJetMin[4];
TH1F* hnblJetMax[4];
TH1F* hnbbJet[4];
TH1F* hnJetWW[4];
...
TH1F* hmt2BJ[4];//MT2 with jets only makes sense if you have >1 jet
...
void bookHistos(const char *prefix) {
  ...
  for (int i=0; i<4; i++) {
	...
	hnJet[i] = new TH1F((string(prefix)+"_hnJet_" + string(suffixall[i])).c_str(),(string(prefix)+"_nJet_" + string(suffixall[i])).c_str(),
			    5,0.,5.);	
        hnbJet[i] = new TH1F((string(prefix)+"_hnbJet_" + string(suffixall[i])).c_str(),(string(prefix)+"_nbJet_" + string(suffixall[i])).c_str(),
                            5,0.,5.);   
        hnblJetMin[i] = new TH1F((string(prefix)+"_hnblJetMin_" + string(suffixall[i])).c_str(),(string(prefix)+"_hnblJetMin_" + string(suffixall[i])).c_str(),
                            100,0.,1000.);   
        hnblJetMax[i] = new TH1F((string(prefix)+"_hnblJetMax_" + string(suffixall[i])).c_str(),(string(prefix)+"_hnblJetMax_" + string(suffixall[i])).c_str(),
                            100,0.,1000.);
        hnbbJet[i] = new TH1F((string(prefix)+"_hnbbJet_" + string(suffixall[i])).c_str(),(string(prefix)+"_hnbbJet_" + string(suffixall[i])).c_str(),
                            200,0.,600.);
        hmt2BJ[i] = new TH1F((string(prefix)+"_hmt2BJ_" + string(suffixall[i])).c_str(),(string(prefix)+"_hmt2BJ_" + string(suffixall[i])).c_str(),
                            30,0.,300.);
	...
	hnJet[i]->GetXaxis()->SetTitle("nJets");
        ...
        hnbJet[i]->SetDirectory(rootdir);
        hnbJet[i]->GetXaxis()->SetTitle("nbJets");
	...
	for(int k = 0; k<5; k++) {
	  ...
	  hnJet[i]->GetXaxis()->SetLabelSize(0.07);
          ...
          hnbJet[i]->GetXaxis()->SetBinLabel(k+1, jetbins[k]);
          hnbJet[i]->GetXaxis()->SetLabelSize(0.07);
      ...
      hmet[i][j] = new TH1F((string(prefix)+"_hmet_" + string(suffix[i])).c_str(),(string(prefix)+"_met_" + string(suffix[i])).c_str(),10, 0., 100.);
      ...
      //pf
      hpfmet[i][j] = new TH1F((string(prefix)+"_hpfmet_" + string(suffix[i])).c_str(),(string(prefix)+"_pfmet_" + string(suffix[i])).c_str(),10, 0., 100.);
