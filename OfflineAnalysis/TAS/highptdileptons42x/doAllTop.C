...
//     const float LUMINORM = 1; // 1 fb-1
  ...
  if(rundata) {
    cout << "Doing data" << endl;
      ...
      ch_data->Add("/nfs-3/userdata/kalavase/skims/Mu_Run2010A-Nov4ReReco_v1_RECO/V03-06-16/skimmed_ntuple.root");
      ch_data->Add("/nfs-3/userdata/kalavase/skims/Mu_Run2010B-Nov4ReReco_v1_RECO/V03-06-17/skimmed_ntuple.root");

      ch_data->Add("/nfs-3/userdata/kalavase/skims/EG_Run2010A-Nov4ReReco_v1_RECO/V03-06-16/skimmed_ntuple.root");
      ch_data->Add("/nfs-3/userdata/kalavase/skims/Electron_Run2010B-Nov4ReReco_v1_RECO/V03-06-16/skimmed_ntuple.root");
  ...
  if(runttbar) {
    ...
    ch_ttbar->Add("/nfs-3/userdata/cms2/TTJets_TuneD6T_7TeV-madgraph-tauola_Fall10-START38_V12-v2/V03-06-17/diLepPt2020Skim/*.root"); 
  ...
  if(runVV) {
    cout << "Processing VV" << endl;
        ch_vv->Add("/nfs-3/userdata/cms2/ZZtoAnything_TuneZ2_7TeV-pythia6-tauola_Fall10-START38_V12-v1/V03-06-14/dilepPt2010Skim/skimmed_ntuple.root");
        ch_vv->Add("/nfs-3/userdata/cms2/WZTo3LNu_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/merged*.root");
        ch_vv->Add("/nfs-3/userdata/cms2/WWTo2L2Nu_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/merged*.root");
  ...
  if(runtW) {
    ...
    ch_tw->Add("/nfs-3/userdata/cms2/TToBLNu_TuneZ2_tW-channel_7TeV-madgraph_Fall10-START38_V12-v2/V03-06-14/diLepPt2020/merged*.root");
  ...
  if (runWjets) {
    cout << "Processing Wjets.."<<endl;
      ch_wjets->Add("/nfs-3/userdata/cms2/WToENu_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/merged_ntuple*.root");
      ch_wjets->Add("/nfs-3/userdata/cms2/WToMuNu_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/merged_ntuple*.root");
      ch_wjets->Add("/nfs-3/userdata/cms2/WToTauNu_TuneZ2_7TeV-pythia6-tauola_Fall10-START38_V12-v1/V03-06-14/merged_ntuple*.root");
...
//    ch_wjets->Add("/nfs-3/userdata/cms2/WJets-madgraph_Spring10-START3X_V26_S09-v1_SingleLep/V03-04-08/*.root");
  ...
  if (runDYee) {
    cout << "Processing DY->ee" << endl;
        //ch_dyee->Add("/nfs-3/userdata/cms2/DYToEE_M-10To20_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/dilepPt2010Skim/skimmed_ntuple*.root");
        //ch_dyee->Add("/nfs-3/userdata/cms2/DYToEE_M-20_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/dilep2010_ZMassLessThan50Skim/skimmed_ntuple*.root");
        //ch_dyee->Add("/nfs-3/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Fall10-START38_V12-v2/V03-06-14/dilepPt2010Skim/skimmed_ntuple*.root");      
        ch_dyee->Add("/nfs-3/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Fall10-START38_V12-v3/V03-06-18/dilepPt2010Skim/skimmed_ntuple*.root");
    ScanChain(ch_dyee, v_Cuts, "DYee",doFRestimation, jetTriggerPt, LUMINORM);
    hist::color("DYee", kMagenta);
  }
  if (runDYmm) {
    cout << "Processing DY->mm" << endl;
        //ch_dymm->Add("/nfs-3/userdata/cms2/DYToMuMu_M-10To20_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/dilepPt2010Skim/skimmed_ntuple*.root");
        //ch_dymm->Add("/nfs-3/userdata/cms2/DYToMuMu_M-20_TuneZ2_7TeV-pythia6_Fall10-START38_V12-v1/V03-06-14/dilep2010_ZMassLessThan50Skim/skimmed_ntuple*.root");
        //ch_dymm->Add("/nfs-3/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Fall10-START38_V12-v2/V03-06-14/dilepPt2010Skim/skimmed_ntuple*.root");      
        ch_dymm->Add("/nfs-3/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Fall10-START38_V12-v3/V03-06-18/dilepPt2010Skim/skimmed_ntuple*.root");
    ScanChain(ch_dymm, v_Cuts, "DYmm",doFRestimation, jetTriggerPt, LUMINORM);
    hist::color("DYmm", kCyan);
  }
  if (runDYtautau) {
    cout << "Processing DY->tautau" << endl;
        //ch_dytt->Add("/nfs-3/userdata/cms2/DYToTauTau_M-10To20_TuneZ2_7TeV-pythia6-tauola_Fall10-START38_V12-v1/V03-06-14/dilepPt2010Skim/skimmed_ntuple.root");
        //ch_dytt->Add("/nfs-3/userdata/cms2/DYToTauTau_M-20_TuneZ2_7TeV-pythia6-tauola_Fall10-START38_V12-v1/V03-06-14/dilep2010_ZMassLessThan50Skim/skimmed_ntuple.root");
        //ch_dytt->Add("/nfs-3/userdata/cms2/DYJetsToLL_TuneD6T_M-50_7TeV-madgraph-tauola_Fall10-START38_V12-v2/V03-06-17/dilepPt2010Skim/skimmed_ntuple*.root");

        ch_dytt->Add("/nfs-3/userdata/cms2/DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola_Fall10-START38_V12-v3/V03-06-18/dilepPt2010Skim/skimmed_ntuple*.root");
