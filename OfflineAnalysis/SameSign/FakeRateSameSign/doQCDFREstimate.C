...
void doAll(){
  ...
  ch_pthat30to80->Add("/data/tmp/cms2-V01-03-01/QCDpt30_Summer08_IDEAL_V11_redigi_v1-SingleLepton/merged_ntuple*.root");
//  ch_pthat30to80->Add("/data/tmp/cms2-V01-03-01/QCDpt80_Summer08_IDEAL_V11_redigi_v1-SingleLepton/merged_ntuple*.root");
...
//  ch_pthat80->Add("/data/tmp/cms2-V01-03-01/QCDpt80_Summer08_IDEAL_V11_redigi_v1-SingleLepton/merged_ntuple*.root");
  ...
  ch_WJets->Add("/data/tmp/cms2-V01-03-01/WJets-madgraph_Summer08_IDEAL_V11_redigi_v1/merged*.root");
//  ch_WJets->Add("/data/tmp/cms2-V01-03-01/Wc-madgraph_Fall08_IDEAL_V11_redigi_v1/merged*.root");
/*
