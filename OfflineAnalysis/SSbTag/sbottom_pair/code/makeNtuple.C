...
void makeNtuple(){
  ...
  float xsecdwn[2000];
  int nxsec=0;
  ifstream fromfile("sbottom_xsec.txt");
  if ( !fromfile.good() ) {
  ...
  filenames.push_back("SR1_50_sorted.txt");
  filenames.push_back("SR2_50_sorted.txt");
  filenames.push_back("SR3_50_sorted.txt");
  filenames.push_back("SR4_50_sorted.txt");
  filenames.push_back("SR5_50_sorted.txt");
  filenames.push_back("SR6_50_sorted.txt");
  filenames.push_back("SR7_50_sorted.txt");
