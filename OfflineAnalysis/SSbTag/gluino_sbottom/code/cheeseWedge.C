{
    ...
    char * selection ="Same Sign dileptons with btag selection  m(#tilde{#chi_{1}^{0}}) = 50 GeV";
    char * masses = Form("m(#tilde{#chi_{1}^{0}}) = 50 GeV");
    ...
    latexLabel.DrawLatex(500, 345, "#color[2]{m(#tilde{#chi_{1}^{+}}) = 150 GeV}");
    latexLabel.DrawLatex(560, 495, "#color[4]{m(#tilde{#chi_{1}^{+}}) = 300 GeV}");
