...
// of time, eg,
// sort sbottomp_mchi150_sr1.txt  > SR1_mchi150_sorted.txt
// sort sbottomp_mchi150_sr2.txt  > SR2_mchi150_sorted.txt
// sort sbottomp_mchi150_sr3.txt  > SR3_mchi150_sorted.txt
// sort sbottomp_mchi150_sr4.txt  > SR4_mchi150_sorted.txt
// sort sbottomp_mchi150_sr5.txt  > SR5_mchi150_sorted.txt
// sort sbottomp_mchi150_sr6.txt  > SR6_mchi150_sorted.txt
// sort sbottomp_mchi150_sr7.txt  > SR7_mchi150_sorted.txt
//
//
...
void makeNtuple (int chi_mass) {

    //-----------------------------------------------
    // The name of the file with the output ntuple
    //-----------------------------------------------
    char* ntFile = Form("ntuple_%d.root", chi_mass);
    ...
    filenames.push_back(Form("../txt/sbottomp_mchi%d_sr1.txt", chi_mass));
    filenames.push_back(Form("../txt/sbottomp_mchi%d_sr2.txt", chi_mass));
    filenames.push_back(Form("../txt/sbottomp_mchi%d_sr3.txt", chi_mass));
    filenames.push_back(Form("../txt/sbottomp_mchi%d_sr4.txt", chi_mass));
    filenames.push_back(Form("../txt/sbottomp_mchi%d_sr5.txt", chi_mass));
    filenames.push_back(Form("../txt/sbottomp_mchi%d_sr6.txt", chi_mass));
    filenames.push_back(Form("../txt/sbottomp_mchi%d_sr7.txt", chi_mass));
