...
class myBabyMaker
{
  ...
  Bool_t v4SS_;  // electronSelectionFO_ssVBTF80_v4
  ...
  Bool_t v4SSAug9_;  // electronSelectionFO_ssVBTF80_v4, isData, true
  ...
  // PF Btag information
  Int_t nbpfjet_; // number of btagged pfjet pt>15
  Float_t dRbpfNear_; // dR between lepton and closest such pfjet
  Float_t dRbpfFar_; // dR between lepton and farthest such pfjet
...
<<<<<<< myBabyMaker.h
  Bool_t  btag_;           // btag flag


  // Information to do offline jet trigger selection - PF Jet
  Float_t ptpfj1_;        // highest pt jet well separated from the lepton
  Float_t ptpfj1_b2b_;    // highest pt jet away frmo lepton by dR >= 1.0 and dPhi > 2.5
  Float_t dphipfj1_b2b_;  // dphi between lepton and jet for jets away from lepton by dR >= 1.0
  Int_t   npfj1_;         // number of jets above 10 GeV and away from lepton by dR >= 1.0
  Bool_t  btagpf_;         // PF btag flag
