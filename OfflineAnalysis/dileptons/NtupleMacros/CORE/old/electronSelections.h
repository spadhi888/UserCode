...
bool pass_electronSelection(const unsigned int index, const cuts_t selectionType, bool applyAlignmentCorrection = true);
cuts_t electronSelection(const unsigned int index, bool applyAlignmentCorrection = true);
...
// "VBTF" id
//
electronIdComponent_t electronId_VBTF(const unsigned int index, const vbtf_tightness tightness,  bool applyAlignementCorrection = true);
