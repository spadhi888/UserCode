...
// data: Photon10 OR Electron 10 OR Photon 15 OR DoubleEle5 OR DoublePhoton10
// MC  : E10 OR Photon15
...
bool goodEGTrigger5July2010 (bool mc) {
  if (mc) {
   ...
   int e10 = nHLTObjects("HLT_Ele10_LW_L1R");
    ...
    int e5 = nHLTObjects("HLT_DoubleEle5_SW_L1R");
    if (e5 != 0) return true;

    int e15 = nHLTObjects("HLT_Ele15_LW_L1R");
    if (e15 != 0) return true;

    int e151 = nHLTObjects("HLT_Ele15_SW_L1R");
    if (e151 != 0) return true;

    int e152 = nHLTObjects("HLT_DoubleEle10_LW_OnlyPixelM_L1R");
    if (e152 != 0) return true;
    ...
    p10 = nHLTObjects("	HLT_DoublePhoton10_L1R");
    if (p10 != 0) return true;
