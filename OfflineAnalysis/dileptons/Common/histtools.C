...
namespace hist {
  ...
  void stack(const char* stackHistName, const char* patORpfx, Bool_t addColor, Option_t* drawOption, Int_t orderScheme,
	     const char* bsmName, bool doRefPats, std::string prefixToSkip) {
    ...
    if (orderScheme == 0){
      ...
      //pats.push_back(new TString("qcd30_"));
      //pats.push_back(new TString("tW_"));
      //pats.push_back(new TString("DYtautau_"));
      //pats.push_back(new TString("DYee_"));
      //pats.push_back(new TString("DYmm_"));
      //pats.push_back(new TString("wj_"));
      //pats.push_back(new TString("zz_"));
      //pats.push_back(new TString("wz_"));
      //pats.push_back(new TString("ww_"));
