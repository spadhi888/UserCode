...
\bibitem{cdf:recentSusy} {``CDF: Search for...''}, ... .

\bibitem{d0:recentSusy} {``D0: Search for...''}, ... .
...
\bibitem{cite:cousins} arXiv:physics/0702156 [physics.data-an]

\bibitem{cite:conway} arXiv:physics/yyyyy [xxxx]
