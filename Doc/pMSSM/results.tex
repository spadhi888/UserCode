...
The results we have presented here, with only 35 pb$^{-1}$ of CMS data, show that even with modest amount of data, we are able to start making inferences of a general nature
about supersymmetry. 
