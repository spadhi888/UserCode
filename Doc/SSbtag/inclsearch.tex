...
%We refer to SSVHEM with the requirement that three of the tracks have $IP$ 
...
\begin{table}[hbt]
\begin{center}
\include{yields/btag_simplified_model}
\end{center}
