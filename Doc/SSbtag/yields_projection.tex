...
\begin{table}[h]
\begin{center}
\include{yields_projection/btag_ht80_200met0}
\end{center}
...
\begin{table}[hbt]
\begin{center}
\include{yields_projection/btag_ht200_320met0}
\end{center}
\caption{\label{tab:yield_ht200_320met0}Observed event yields for 200 $< H_T < $ 320 GeV and \met $>$ 0 GeV
compared to expectations from simulation alone, and from the data-driven methods.
The {\em simulated backgrounds} contribution includes contributions from genuine  same-sign lepton
pairs (WZ, ZZ, leptons from same-sign W from single-parton, double-parton, and $t\bar{t}W$ production, etc.), 
as well as electrons from converted photons in $V\gamma$ production.
...
\begin{table}[hbt]
\begin{center}
\include{yields_projection/btag_ht320met0}
\end{center}
\caption{\label{tab:yield_ht320met0}Observed event yields for $ H_T > $ 320 GeV and \met $>$ 0 GeV
compared to expectations from simulation alone, and from the data-driven methods.
The {\em simulated backgrounds} contribution includes contributions from genuine  same-sign lepton
pairs (WZ, ZZ, leptons from same-sign W from single-parton, double-parton, and $t\bar{t}W$ production, etc.), 
as well as electrons from converted photons in $V\gamma$ production.
...
\begin{table}[hbt]
\begin{center}
\include{yields_projection/btag_ht80met0_30}
\end{center}
\caption{\label{tab:yield_ht80met0_30}Observed event yields for $ H_T > $ 80 GeV and 0 $<$ \met $<$ 30 GeV
compared to expectations from simulation alone, and from the data-driven methods.
The {\em simulated backgrounds} contribution includes contributions from genuine  same-sign lepton
pairs (WZ, ZZ, leptons from same-sign W from single-parton, double-parton, and $t\bar{t}W$ production, etc.), 
as well as electrons from converted photons in $V\gamma$ production.
