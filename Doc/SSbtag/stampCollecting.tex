...
from SR1 (see~\ref{fig:sbottomoptimize}), which
...
we smoothed smoothed the limit line into a vertical line.
Note also that
...
{\bf I think this figure should be removed.  I see no
statistically significant difference in cross-section
limits for different values of chargino mass.}
...
\caption{Acceptances for the {\tt T1tttt} (top left), 
sbottom pair (top right), and gluino sbottom (bottom) models; 
these acceptances
...
{\bf Nice figure, but needs to be remade.}
