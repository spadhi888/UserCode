...
\begin{itemize}
\item The limits were calculated using 4.65 $\pm$ 0.61 $\pm$ 1.0 for the 
BG, which is an old number.
...
\item It would be nice to have a reference.  I am not sure that the referenes that
...
\label{sec:gbb}
This model is gluino pair production followed by 
