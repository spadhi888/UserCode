...
the best expected limit. Using $\met > 50$ GeV and $H_T > 200$ GeV, which corresponds 
...
Fig.~\ref{fig:mglinoStop} shows $Acc \times Eff \times BR$ in $\tilde{g}$ Vs $\tilde{t_{1}}$ mass plane for LSP mass of 50 GeV.
The limit using NLO+NLL provides the most stringent limit to date on the mass of $\tilde{t_{1}}$ as a function of $\tilde{g}$ mass (VERY PRELIMINARY).

\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.65\linewidth]{figs/gluino_stopefflimit.pdf}
\caption{$Acc \times Eff \times BR$ in $\tilde{g}$ Vs $\tilde{t_{1}}$ mass plane for LSP mass of 50 GeV. The exclusion region using NLO+NLL is also shown as the solid line (VERY PRELIMINARY).
