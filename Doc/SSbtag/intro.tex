...
the background predictions~\ref{sec:inclresults} and also interpret
them as constraints on parameters of various new physics
scenarios, as provided in Section~\ref{sec:stampCollecting}.
