...
\bibitem{ufl} {{\it ``Search for new physics with 
same-sign di-leptons, jets, and missing transverse energy with 4.7 fb$^{-1}$
of data''}}, CMS AN-2011/437.

\bibitem{ethss} {{\it Search for New Physics in the Same-Sign 
Di-Lepton Channel Using 4.7 fb$^{-1}$ of 7 TeV pp Collisions''}}, 
CMS AN-2011/466.

\bibitem{ufl2} {{\it Search for stop and sbottom production with same-sign di-leptons, b-tagged jets and MET}}
CMS AN-2012/001.
...
\bibitem{rpvnomet}{http://arxiv.org/abs/1201.5923}{The Minimal Theory for R-parity Violation at the LHC}

\bibitem{rpvwmet}{http://arxiv.org/abs/1110.6670}{SUSY, The Third Generation and the LHC}
...
\bibitem{eth} ``Computing the contamination from fakes in leptonic 
