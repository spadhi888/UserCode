...
We repeat all the studies performed with 2010 data, as documented in~\cite{ref:fakeRateNote}.
These include 
\begin{itemize}
...
%	described in~\cite{ref:fakeRateNote} represents the lepton fake rate  in the dilepton sample. 
%\end{itemize}
