...
%with ``long'' lived proxies. 
%Each of these \emph{startds} can 
%fkw: I changed this because I do not think glideinWMS supports the parallelism you are mentioning here.
...
as a production server both of which uses glide-in based WMS. The crabserver was tested to a large 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In CMS the MC production is centrally organized. However,
...
%Very recently this system was used to produce Supersymmetric signal
%events involving GMSB models. 
%The ease of its usage makes this system quite attractive
%for the users.
%fkw: we did not use the system for gmsb.
%fkw: I'd keep the tone down a little here.
